...
object Huffman {
   ...
   */
    def mergeCodeTables(a: CodeTable, b: CodeTable): CodeTable = {
      def mergeCodeTables0(n:Int,entry:((Char, List[Bit]))):(Char, List[Bit])= entry match {
        case (c,b)=>(c,n::b)
      }
      a.map(mergeCodeTables0(0,_)):::b.map(mergeCodeTables0(1,_))
    }
